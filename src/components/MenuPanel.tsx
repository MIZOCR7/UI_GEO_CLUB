    ...
    >
      <nav className="flex flex-col gap-2">
        <a
          href="/"
          onClick={onClose}
          className="text-[36px] md:text-[42px] font-medium text-[#F4F1E8] no-underline leading-[130%] hover:opacity-70 transition-opacity duration-300"
        >
          Main
        </a>
        <a
      ...
      <div className="flex flex-col gap-5 mt-8">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-[18px] md:text-[20px] text-[#9A9590] no-underline hover:text-[#F4F1E8] transition-colors duration-300"
        >
          Ziad Emad Ahmed
        </a>
        <div className="flex gap-6">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[14px] text-[#9A9590] underline underline-offset-2 hover:text-[#F4F1E8] transition-colors duration-300"
          >
            Instagram
          </a>
          <a
      ...
      <div className="mt-8">
        ...
        >
          ...
          />
          <span className="menu-cta-text relative z-1 text-[#111111] font-medium text-[14px] px-10 py-2 whitespace-nowrap">
            Chat with AI
          </span>
          <span className="menu-cta-circle relative z-1 flex items-center justify-center w-[38px] h-[38px] rounded-full bg-[#75C5DE] shrink-0 transition-transform duration-300">
